  ...
  freshFlowers: Product[] = [
    {
      ...
      title: 'Buket Amna',
      description: 'Roza boja cvijeća u buketu simbolizira romantiku, dok ljubičasti detalji prenose dašak neovisnosti i kreativnosti. Rozo pakovanje upotpunjava ženstvenu poruku koju šalje buket Amna.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-2.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Ajla',
      description: 'Tulipani kao simbol preporoda i dobročinstva. Kombinacija bilo kojih boja prenosi poruku duboke ljubavi. Prirodno smeđe pakovanje upotpunjava veselu poruku koju šalje buket Ajla.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-3.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Sara',
      description: 'Buket koji zrači nježnošću i na fotografiji. Simbolika čistoće bijelog cvijeća i umirujuća zelena boja pakovanja prenose umirujuću poruku koju šalje buket Sara.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-4.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Dalila',
      description: 'Žuto cvijeće simbolizira radost, sreću i pozitivnu energiju. Nosi poruke veselja i radosti. Prirodno smeđe pakovanje zaokružuje vedru poruku koju šalje buket Dalila.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-5.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Nur',
      description: 'Pastelne nijanse cvjetova obogaćene elegancijom i toplinom eukaliptusa nose poruke topline, sigurnosti i harmonije. Bijelo pakovanje upotpunjava čistoću poruka koje šalje buket Nur.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-6.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Azure',
      description: 'Dubinu i stabilnost boje neba i mora, plave boje, obogaćuje čistoća kombinacije bijelog cvijeća. Prirodno smeđe pakovanje harmonizira poruke koje šalje buket Azure.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-7.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Enesa',
      description: 'Mix boja sezonskog cvijeća obgrljen prirodnim smeđim pakovanjem prenosi poruke radosti, ispunjenosti i sigurnosti koje šalje buket Enesa.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-8.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Esma',
      description: 'Kombinacija nijansiranog rozog cvijeća odiše romantikom i poštovanjem dok bijelo cvijeće odiše nežnošću i čistoćom. Rozo pakovanje upotpunjava ljepotu poruke koju šalje buket Esma.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-9.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Amina',
      description: 'Cvijeće ljubičastih tonova prenosi poruku raskoša i elegancije upotpunjenu nježnošću bjeline gipsofila. Ljubičasto pakovanje dodatno naglašava elegantnost poruke koju šalje buket Amina.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-10.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Lejla',
      description: 'Crvene ruže kao simbol snage, hrabrosti i ljubavi šalju poruku osjećajnosti i odanosti. Crno pakovanje upotpunjava elegancijom i odanošću poruku koju šalje buket Lejla.'
    },
    {
      imgSrc: 'assets/img/products/bouquets/buket-11.png',
      imgAlt: 'Fresh Flower Bouquet',
      title: 'Buket Una',
      description: 'Ranunkuli odišu nježnošću i njihove raznobojne latice šalju najromantičnije poruke obogaćene umirujućim zelenilom eukaliptusa. Prirodno smeđe pakovanje naglašava jednostavnost ljepote poruka koje šalje buket Una.'
    }
  ];
  ...
  magnets: Product[] = [
    {
      ...
      title: 'Fikus',
      description: 'Biljka koja simboliše obilje, sreću i bogatstvo i pomaže u protoku dobre energije u okruženju.'
    },
    {
      imgSrc: 'assets/img/products/potted-plants/loncanica-2.png',
      imgAlt: 'Decorative Magnet',
      title: 'Calathea',
      description: 'Biljka molitve čiji se listovi pomjeraju u toku dana svakodnevno nudeći novi pogled na rast biljaka.'
    },
    {
      imgSrc: 'assets/img/products/potted-plants/loncanica-3.png',
      imgAlt: 'Decorative Magnet',
      title: 'Spatifilum',
      description: 'Biljka poznata i kao mirni ljiljan ali i ženska sreća simbolozira mir, čistoću, nadu i blagostanje.'
    },
    {
      imgSrc: 'assets/img/products/potted-plants/loncanica-4.png',
      imgAlt: 'Decorative Magnet',
      title: 'Zamija',
      description: 'Biljka novca i sreće koja unosi pozitivnu energiju i blagostanje  u okruženje.'
    },
    {
      imgSrc: 'assets/img/products/potted-plants/loncanica-5.png',
      imgAlt: 'Decorative Magnet',
      title: 'Dracena',
      description: 'Biljka poznata i pod imenom ženski zmaj, jako učinkovita kao pročišćivač zraka u okruženju.'
    },
    {
      imgSrc: 'assets/img/products/potted-plants/loncanica-6.png',
      imgAlt: 'Decorative Magnet',
      title: 'Sansevieria',
      description: 'Biljka za koju se vezuju različita imena od kojih su najpopularnija svekrvin jezik, zmijska biljka i sabljica. Njena sposobnost otpuštanja kisika noću razlikuje je od većine sobnog bilja.'
    },
    {
      imgSrc: 'assets/img/products/potted-plants/loncanica-7.png',
      imgAlt: 'Decorative Magnet',
      title: 'Šeflera',
      description: 'Biljka kišobran ima sposobnost apsorbcije mnogih štetnih materija iz vazduha i sjajan je počišćivač.'
    }
  ];
