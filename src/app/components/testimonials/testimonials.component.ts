  ...
  testimonials = [
    {
      ...
      name: '#huzurljudi',
      imagePath: 'assets/img/testimonials/optimized/recenzija-1.webp',
      flipped: false,
      cardFlipping: false
    },
    {
      ...
      name: '#huzurljudi',
      imagePath: 'assets/img/testimonials/optimized/recenzija-2.webp',
      flipped: false,
      cardFlipping: false
    },
    {
      ...
      name: '#huzurljudi',
      imagePath: 'assets/img/testimonials/optimized/recenzija-3.webp',
      flipped: false,
      cardFlipping: false
    },
    {
      ...
      name: '#huzurljudi',
      imagePath: 'assets/img/testimonials/optimized/recenzija-4.webp',
      flipped: false,
      cardFlipping: false
    },
    {
      ...
      name: '#huzurljudi',
      imagePath: 'assets/img/testimonials/optimized/recenzija-5.webp',
      flipped: false,
      cardFlipping: false
    },
    {
      ...
      name: '#huzurljudi',
      imagePath: 'assets/img/testimonials/optimized/recenzija-6.webp',
      flipped: false,
      cardFlipping: false
    }
  ];
